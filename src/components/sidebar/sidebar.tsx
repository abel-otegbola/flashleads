                        ...
                        generalLinks.map(link => {
                            if (link.label === 'Profile') {
                                ...
                                <>
                                    ...
                                    <Link key={link.id} onClick={() => setOpen(false)} to={ link.link} className={`relative flex items-center justify-between px-3 py-3 h-[48px] rounded-[6px] duration-300 ${pathname.includes(link.link) ? "sm:bg-white bg-gray-100/[0.2] font-bold" : "font-semibold opacity-75 hover:bg-gray-100/[0.2]"}`}>
                            ...
                            if (link.label === 'Logout') {
                                    return (
                                        <button
                                            ...
                                            className={`relative w-full text-left flex items-center justify-between px-3 py-1 h-[48px] rounded-[6px] duration-300 cursor-pointer ${pathname.includes(link.link) ? "sm:bg-white bg-gray-100/[0.2] font-bold text-primary" : "font-semibold opacity-75 hover:bg-gray-100/[0.2]"}`}>
                                            <div className="flex items-center gap-3">
